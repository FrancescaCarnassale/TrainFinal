	...
	<div id="start-page" style="background-color: #ceead6; height: 100vh"
		...
		<div class="div-container">
			...
			<div class="div-button">
				<button onClick="location.href='/TrainViewer/trainGame/Game.jsp'"
					style="background-color: #9E579D; color: white; box-shadow: 0 4px 0 #9E579D; border: none; display: block; font-size: .875rem; font-weight: 500; height: 36px; margin: 12px; min-width: 200px; padding: 0px 24px;"
					id="title-start-btn" class="btn primary-btn" dir="auto">Inizia</button>
			</div>
		</div>
	</div>
</body>
