...
<link href="https://fonts.googleapis.com/css?family=Google+Sans:medium"
	rel="stylesheet">
<!-- CSS only -->
...
<body id="b01" class="bg-white body-game" onkeydown="checkKeyDown(event);"
	...
	<div id="loader"
		style="align-items: center; justify-content: center; display: flex; flex-direction: row; padding-top: 10%">
		<div
			style="align-items: center; display: flex; flex-direction: column;">
			<img
				src="https://thumbs.gfycat.com/InferiorDecentAsianporcupine-max-1mb.gif"
				style="padding-left: 5rem; width: 25rem" alt="Loading...">
	...
	<div id="outerContainer" style="background-color: white">
		...
		<div class="container" id="container-game">
			<input id="btnPlay" type="button" onclick="play()" value="Play"
				class="btnPlay"></input>
		...
		<div class="container bg-dark" id="container-score"
			style="background: linear-gradient(to right, #574B90, #9E579D);">
			<div id="counter"></div>
			<h1 class="py-4 text-center text-white bg-dark" id="title-score"
				style="background: linear-gradient(to right, #574B90, #9E579D);">Best
				Scores</h1>
			<form action="GameServlet" method="GET">
				<table class="table table-dark table-striped" id="score-table">
					<thead>
						<tr>
							<th scope="col"
								style="background: linear-gradient(to right, #574B90, #9E579D);">Username</th>
							<th scope="col"
								style="background: linear-gradient(to right, #574B90, #9E579D);">Score</th>
						</tr>
					</thead>
					<tbody>
						<tr>
