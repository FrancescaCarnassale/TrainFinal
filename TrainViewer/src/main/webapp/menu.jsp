        	      ...
        	      <ul class="navbar-nav">
        	        ...
        	        <li class="nav-item">
        	          <a class="nav-link" aria-current="page" href="/TrainViewer/creazioneTrenoAdmin/creazioneTreno.jsp">CreazioneTreno</a>
        	                	        ...
        	                	        <li class="nav-item">
        	          <a class="nav-link" aria-current="page" href="/TrainViewer/creazioneTripAdmin/creazioneTrip.jsp">Crazione Trip</a>
        	        </li>
        	      </ul>
        	    </div>
        	  </div>
        	...
        	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        	  <div class="container-fluid">
        	    ...
        	    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        	      <ul class="navbar-nav">
        	        <li class="nav-item">
        	          <a class="nav-link active" aria-current="page" href="/TrainViewer/index.jsp"></a>
        	        </li>
        	        <li class="nav-item">
        	          <a class="nav-link" aria-current="page" href="/TrainViewer/admin.jsp">ApproveAliases Admin</a>
        	        </li> 	
        	        ...
        	        <li class="nav-item">
        	          <a class="nav-link" aria-current="page" href="/TrainViewer/creazioneTrenoAdmin/creazioneTreno.jsp">CreazioneTreno</a>
        	                	        ...
        	                	        <li class="nav-item">
        	          <a class="nav-link" aria-current="page" href="/TrainViewer/creazioneTripAdmin/creazioneTrip.jsp">Creazione Trip</a>
        	        </li>
        	      </ul>
        	    </div>
        	  </div>
